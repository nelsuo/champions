...
function _attachGameUi(gameId, connection, inverted) {
    var game = games[gameId];
    var gameUi = new GameUi(connection, game, inverted);
    game.addUi(gameUi);
    return gameUi;
}
...
function _addPlayerToGame(gameId, connection) {
    ...
    var player = new Player(connection, game);
    ...
    this.ws.on('message', function(message) {
        ...
        switch(payload.action) {
            ...
            case 'attach-game-ui':
                ...
                this.instance = _attachGameUi(data.gameId, this, data.inverted);
                this.send('game-ui-attached');
            break;
            case 'add-player':
